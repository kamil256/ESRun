...
// public class PropertyProcessor : INodeProcessor<Property, KeyValuePair<EsString, PropertyDescriptor>>
// {
//     protected readonly Lazy<INodeProcessor<FunctionExpression, EsValue>> _functionExpressionProcessor;
...
//     public PropertyProcessor(Lazy<INodeProcessor<FunctionExpression, EsValue>> functionExpressionProcessor,
...
//     public KeyValuePair<EsString, PropertyDescriptor> Process(Property node, Scope scope)
//     {
...
//         var identifier = new EsString(identifierNode.Name);
//         var value = GetValue(node.Value, scope);

//         return new KeyValuePair<EsString, PropertyDescriptor>(identifier, new PropertyDescriptor(/*value*/));
//     }
